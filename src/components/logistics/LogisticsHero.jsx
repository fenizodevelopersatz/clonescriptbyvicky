...
export default function LogisticsHero() {
  return (
    <section className="logistics-hero vc_row wpb_row vc_row-fluid sv_first_row liquid-row-shadowbox">
                  ...
                  <div className="ld-fancy-heading text-center">
                    <h1 className="lqd-highlight-underline lqd-highlight-grow-left">
                      <span className="ld-fh-txt">
                        <span style={{ color: '#38bdf8' }}>On-Demand Logistics Service App</span>
                        <br />
