...
export default function UberHero() {
  return (
    <section className="vc_row wpb_row vc_row-fluid sv_first_row liquid-row-shadowbox uber-hero">
                ...
                <Reveal as="div" className="wpb_wrapper-inner" duration={1.2}>
                  <div className="ld-fancy-heading text-center">
                    <h1 className="lqd-highlight-underline lqd-highlight-grow-left">
                      <span className="ld-fh-txt"> Launch a Feature-Rich <span style={{ color: '#ffc53c' }}>Uber Clone</span> for Your Taxi Business</span>
                    </h1>
                  </div>
                  <div className="wpb_text_column wpb_content_element">
                    <div className="wpb_wrapper">
                      <p style={{ textAlign: 'center' }}>Build a modern ride-hailing platform with CloneScript and connect passengers with verified drivers through a convenient web and mobile experience. The Uber Clone provides dedicated apps for passengers and drivers, plus a centralized admin panel to manage the entire taxi-booking business — from ride requests and live tracking to payments, commissions, and safety alerts.</p>
                    </div>
                  </div>
